				...
				<?php } else { ?>
					...
					<div class="post-descr-wrap">
						...
						<?php if ($post_format == 'link') { ?>
							<a class="post-format-link-url heading_font" href="<?php echo esc_url( $format_link_url ); ?>"  target="_blank" title="<?php printf( esc_attr__('Permalink to %s', 'voyager'), the_title_attribute('echo=0') ); ?>" rel="bookmark"><i class="fa fa-external-link"></i><?php echo esc_url( $format_link_url ); ?></a>
						<?php } ?>
