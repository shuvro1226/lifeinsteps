...
$post_excerpt = (cstheme_smarty_modifier_truncate(get_the_excerpt(), 330));
?>
 
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<div class="post-content-wrapper clearfix" data-appear-top-offset="-200" data-animated="fadeInUp">
				...
				<?php if($post_format == 'quote') { ?>
					...
					<div class="post-content-quote-wrapper">
						...
						<div class="quote-format-wrap text-center">
							<div class="container">
								<i class="format_label heading_font">”</i>
				...
				<?php } else { ?>
					...
					<?php if( $post_format == 'gallery' ){ ?>
						...
						<div class="post_format_content mb0">
							<?php get_template_part( 'framework/post-format/post', get_post_format() ); ?>
						</div>
						
					<?php } else { ?>
						
						<a href="<?php the_permalink(); ?>" class="featured_img_bg" 
