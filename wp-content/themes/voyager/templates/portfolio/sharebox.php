<div class="sharebox">
	...
	<div class="sharebox_links">
		<?php if(cstheme_option('check_portfolio_sharingboxfacebook') == true) { ?>
		...
		<?php if(cstheme_option('check_portfolio_sharingboxtwitter') == true) { ?>
		...
		<?php if(cstheme_option('check_portfolio_sharingboxlinkedin') == true) { ?>
		...
		<?php if(cstheme_option('check_portfolio_sharingboxreddit') == true) { ?>
		...
		<?php if(cstheme_option('check_portfolio_sharingboxdigg') == true) { ?>
		...
		<?php if(cstheme_option('check_portfolio_sharingboxdelicious') == true) { ?>
		...
		<?php if(cstheme_option('check_portfolio_sharingboxgoogle') == true) { ?>
		...
		<?php if(cstheme_option('check_portfolio_sharingboxpinterest') == true) { ?>
		...
		<?php if(cstheme_option('check_portfolio_sharingboxtumblr') == true) { ?>
