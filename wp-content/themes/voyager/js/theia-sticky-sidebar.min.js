...
jQuery(window).load(function() {
	...
	//	Sticky Sidebar
	if (jQuery('#blog_list').size() > 0) {
		jQuery('#blog_sidebar').theiaStickySidebar({
			containerSelector: '#blog_list > .row',
	...
	if (jQuery('#blog-single-wrap').size() > 0) {
		jQuery('#blog_sidebar').theiaStickySidebar({
			containerSelector: '#blog-single-wrap > .row',
            additionalMarginTop: 100,
            additionalMarginBottom: 0,
            minWidth: 977
		});
	...
	if (jQuery('#shop_page').size() > 0) {
		jQuery('#shop_sidebar').theiaStickySidebar({
			containerSelector: '#shop_page > .container',
            additionalMarginTop: 100,
            additionalMarginBottom: 0,
            minWidth: 977
		});
